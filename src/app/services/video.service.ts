...
export class VideoService {
  ...
  private videos = [
    ...
    {
      title:
        'Unlock Lightning Fast Web API Deployment to Azure with GitHub Actions!',
      description: null,
      videoId: 'tRknlvuFfjM',
    ...
    {
      title:
        'Complete CRUD with .NET Core 8 Web API & EF Core | Step-by-Step Guide | EP17',
      description: null,
      videoId: 'wZQwT4gEysE',
    ...
    {
      title:
        'Azure SQL trigger for Functions | Automate Email on DB Changes | SendGrid Integration with Function',
      description: null,
      videoId: 'PkQxuBT6U_M',
    ...
    {
      title:
        'Azure AD B2C Integration with Angular 18 & .NET Core 8 API | Step-by-Step Guide & Code Change | EP13',
      description: null,
      videoId: '2KdoPKvTqS4',
    ...
    {
      title:
        'Get Ahead of Errors with .NET Core 8 and Application Insights Today!',
      description: null,
      videoId: '2R7-YMlN20k',
    ...
    {
      title:
        "What's Hiding in Your App Settings? Azure Web App Security Secrets!",
      description: null,
      videoId: 'A3MIg862kDU',
    ...
    {
      title:
        'SHOCKING Azure SQL Server Secrets Revealed - Database Setup Made Easy',
      description: null,
      videoId: 'O5RfYfTA5ig',
    ...
    {
      title:
        'MIND-BLOWING NET Core 8 Secrets for Faster Endpoint Creation Revealed',
      description: null,
      videoId: '8KihrPglR2o',
    ...
    {
      title:
        'EP3: Setting Up .NET Core API Project & EF Core Integration | Scaffolding & Dependency Injection',
      description: null,
      videoId: 'CATF49Frgrw',
    ...
    {
      title:
        'EP2: SQL Basics & Database Design for Online Course App | .NET Core & Angular Project | SQL Server',
      description: null,
      videoId: 'HeFUVRUPDxU',
    ...
    {
      title:
        'Get Ready to Master Angular .Net Core 8 Azure in 30 Days | Road Map',
      description: null,
      videoId: 'FRDWi9WWkRc',
    ...
    {
      title:
        'Deploy Angular App to Azure Web App with Azure DevOps | CI/CD Pipeline | Multi-Stage Deployment',
      description: null,
      videoId: 'fqI0ToX1nDQ',
    ...
    {
      title:
        'Angular 18 | Expense Tracker App | Demo & Features | Standalone | Azure AD B2C Authentication',
      description: null,
      videoId: 'RiS229ty-SM',
    ...
    {
      title:
        'Determine Blob Storage Pricing in Azure | Comprehensive Cost Guide | Azure Tips and Tricks',
      description: null,
      videoId: 'qroMqbGTl0k',
    ...
    {
      title:
        'Automate Azure Blobs Lifecycle Management | Azure Storage Lifecycle Policies | Azure Tricks and Tips',
      description: null,
      videoId: 'i9j4nDKl_7U',
    ...
    {
      title:
        'How to Move Azure Storage Blobs Between Containers with Storage Explorer | Azure Tips & Tricks',
      description: null,
      videoId: 'Md0u05679Pg',
    ...
    {
      title:
        '.NET Core 8 Web API Crash Course | Step-by-Step Tutorials for Beginners | Microservice | EF Core',
      description: null,
      videoId: '_2CWPQfzLJo',
    ...
    {
      title:
        'SQL Database Design for absolute Beginner | A Step-by-Step Guide |  Database Design for .Net Core 8',
      description: null,
      videoId: 'ur-f_tyQ0Ic',
    ...
    {
      title:
        'AZ-204 Securing Azure Storage with Key Vault Keys & SSE | Storage Service Encryption | Key Vault Key',
      description: null,
      videoId: 'lDT2-XQ-VG8',
    ...
    {
      title:
        'AZ-204: Implementing Soft Delete and Purge Protection for Azure Key Vaults | Real-Time Demo',
      description: null,
      videoId: 'vs-tcYnQRww',
    ...
    {
      title:
        'AZ-204 Securing Azure App Settings with Key Vault References: Runtime Secret Retrieval | Web API',
      description: null,
      videoId: 'zQh6KWEMN4M',
    ...
    {
      title:
        'AZ-204 Securing Azure Key Vault with Azure AD App Registration: Client ID and Secret Authentication',
      description: null,
      videoId: 'lGMIuIf3psA',
    ...
    {
      title:
        'AZ-204 Unlocking Azure Key Vault Secrets with .NET Core: Enabling System Identity & Access Policies',
      description: null,
      videoId: '5O08RAhUY8Y',
    ...
    {
      title:
        'Azure Managed Identity Interview Questions: Mastering Secure Authentication in Azure | AZ-204',
      description: null,
      videoId: 'jcVW4lznxfw',
    ...
    {
      title:
        'Azure Managed Identity Demo: System & User Identities | AZ-204 Tutorial | Azure | Real-time demo',
      description: null,
      videoId: 'K6Fqanf1Ie0',
    ...
    {
      title:
        'Mastering Azure RBAC: In-Depth Demo and Custom Role Creation Explained | Azure RBAC Tutorial',
      description: null,
      videoId: 'zhYW-cIsM9E',
    ...
    {
      title:
        'AZ-204 Azure Key Vault Tutorial | Keys, Secret & Certificate concepts explained | Azure',
      description: null,
      videoId: '0VOHrOHM2qU',
    ...
    {
      title:
        'E-Commerce Angular Dev Series | Seamless Checkout Process and Order Management | Final Episode',
      description: null,
      videoId: 'LkUqSXMW9M4',
    ...
    {
      title:
        'E-Commerce Angular Dev Series | User Address Management with Reactive Forms | EP16',
      description: null,
      videoId: 'vUcp6FFVC_I',
    ...
    {
      title:
        'E-Commerce Angular Dev Series | Enhancing User Experience with Resolver & Spinner Integration | EP15',
      description: null,
      videoId: '_ZtGG_C8A-w',
    ...
    {
      title:
        'E-Commerce Angular Dev Series | Implementing Route Guards with CanActivateFn and CanActivateChildFn',
      description: null,
      videoId: 'iZ2Rtgmr_S0',
    ...
    {
      title:
        'E-Commerce Angular Dev Series | Set Page Title dynamically using Title Service and Router | EP13',
      description: null,
      videoId: 'sBaSHhLg6c8',
    ...
    {
      title:
        'Configuring Azure AD B2C Authentication & Authorization for .NET Core 8 Web API & Angular | Tutorial',
      description: null,
      videoId: '9RQKHmE9EqQ',
    ...
    {
      title:
        'E-Commerce Angular Dev Series | Building a Dynamic Shopping Cart with Real-Time Updates | EP9',
      description: null,
      videoId: '3ZLfflUR1vQ',
    ...
    {
      title:
        'E-Commerce Angular Dev Series | Utilizing Query Parameters for Dynamic Search | EP8',
      description: null,
      videoId: 'mx95lEz0rEc',
    ...
    {
      title:
        'E-Commerce Angular Dev Series | User Idle Detection with ng-idle & ng-idle/keepalive | EP7',
      description: null,
      videoId: 'IGJMHaQsez0',
    ...
    {
      title:
        'E-Commerce Angular Dev Series | Exploring Input, Output & Lifecycle Hooks | Real-Time Examples | EP6',
      description: null,
      videoId: 'ZyaLQNJYI-E',
    ...
    {
      title:
        'E-Commerce Angular Dev Series | HTTP Service and Routing | EP5 | Web API | Angular 16',
      description: null,
      videoId: 'xBguvt6XbgU',
    ...
    {
      title:
        'AZ-204 Azure Storage Accounts & Blobs | Container Creation, File Uploads, SAS | Azure',
      description: null,
      videoId: '8PnU8DWx9Rw',
    ...
    {
      title:
        'E-Commerce Angular Dev Series | NgModules, Routing, Lazy Loading | EP4 | Angular 16',
      description: null,
      videoId: 'fVbFlQSb2uY',
    ...
    {
      title:
        'E-Commerce Angular Developer Series | NgModules Explained with simple example | EP3',
      description: null,
      videoId: 'lifXMmpqkcM',
    ...
    {
      title:
        'E-Commerce Angular Developer Series | Data Bindings | Angular Directives | EP2 | Angular 16',
      description: null,
      videoId: 'yZKIjFHYLzY',
    ...
    {
      title:
        'E-Commerce Angular Developer Series | Setting Up Your Angular Environment | EP1',
      description: null,
      videoId: 'tBvXGwxw7Jw',
    ...
    {
      title:
        'Practice Assessment for Exam AZ 900: Microsoft Azure Fundamentals | Pass AZ-900 Exam | Q&A | Azure',
      description: null,
      videoId: '4deUZiI34G8',
    ...
    {
      title:
        'Master Azure Cost Management | Price Calculator Tutorial for Service Cost Tracking | Free Azure',
      description: null,
      videoId: 'XvvjGw4WOb0',
    ...
    {
      title:
        'Unlocking the Power of Azure AD B2C Business to Consumers | Short Tutorial | AD B2C #adb2c #azure',
      description: null,
      videoId: 'o83Nb2kOxXY',
    ...
    {
      title:
        'Master Exam AZ-900: Microsoft Azure Fundamentals with 5 Practice Questions | Part 1  #azure #az900',
      description: null,
      videoId: 'cRdHEvyFncA',
    ...
    {
      title:
        'Master Azure AD B2B: Simplifying External User Access in a Snap! | AD B2B #azure #adb2b',
      description: null,
      videoId: 'cj4vRi67XWg',
    ...
    {
      title:
        'Effortless GitHub Integration Pushing Local Code with Visual Studio IDE Tutorial',
      description: null,
      videoId: 'wLQJFMWGiDc',
    ...
    {
      title:
        'Study guide for Exam AZ 204: Developing Solutions for Microsoft Azure | Free | 50% discount',
      description: null,
      videoId: 'WZxRUpDt0Jo',
    ...
    {
      title:
        'E-Commerce 4 Microservices using .NET Core 8, EF Core 8 full project walkthrough | AD B2C | Azure',
      description: null,
      videoId: 'e405NKk89nA',
    ...
    {
      title:
        'How to use .Net Core, EF Core with Azure HTTP Trigger functions | Azure SQL #efcore #azurefunctions',
      description: null,
      videoId: 'S7kP-vqwRww',
    ...
    {
      title:
        'Free Azure SQL Database for a Lifetime | Free SQL DB for the lifetime of your subscription #azuresql',
      description: null,
      videoId: '-o1iKd_eT6g',
    ...
    {
      title:
        'Mastering E-Commerce Database Design: A Step by Step Guide | Full Stack Developer Path | SQL',
      description: null,
      videoId: 'yhMmeB56a20',
    ...
    {
      title:
        'Mastering Full Stack Development Roadmap: Building E-commerce App with .NET 8, Azure, and Angular 17',
      description: null,
      videoId: 'bsU6OIV60IE',
    ...
    {
      title:
        'EF Core 8: Only the invariant culture is supported in globalization-invariant mode | .Net Core 8',
      description: null,
      videoId: 'Eg7k3v0rVwM',
    ...
    {
      title:
        'OAuth 2.0 & OpenID Connect Demystified: Azure AD B2C Explained with Real Examples! #oauth2 #azuread',
      description: null,
      videoId: 'fCFDJaGBAJA',
    ...
    {
      title:
        'Mastering Azure AD B2C: Fundamentals and Key Features with Real-world Examples #b2c #azure #azuread',
      description: null,
      videoId: 'WWyrRYGWumQ',
    ...
    {
      title:
        'Upgrading your .NET projects with Visual Studio using Upgrade Assistant | .Net 8 | Upgrade Assistant',
      description: null,
      videoId: 'XAheI0Jx8vs',
    ...
    {
      title:
        'MASTER Full Stack Web Development with Angular 16, DOTNET Core, Azure & Docker!',
      description: null,
      videoId: '70q8PanGbnw',
    ...
    {
      title:
        'Exploring Services in Angular - A Quick Guide | Angular 16 | Services in Angular | DI | #angular',
      description: null,
      videoId: 'PKnOM9TvGHs',
    ...
    {
      title:
        'Creating a User in Azure Portal and Assigning a Role | Step-by-Step Guide | #azure',
      description: null,
      videoId: 'LCt5SBj_ANs',
    ...
    {
      title:
        'How to Create a Managed Identity in Azure | Step-by-Step Guide #security #azure',
      description: null,
      videoId: 'xzRgQ-2SaSE',
    ...
    {
      title:
        'Master Angular Interview Questions with Live Examples | Top 10 Angular Q&A | #AngularTips',
      description: null,
      videoId: 'ok_2hNPBYhw',
    ...
    {
      title:
        'Master Angular Authentication & Role-Based Authorization in Azure AD B2C | Custom Claims | #b2c',
      description: null,
      videoId: '7iJC1oQXyQE',
    ...
    {
      title:
        'How to Create a Custom Azure AD B2C Login Page (and Why You Should)',
      description: null,
      videoId: 'ZF5ZsJBp54A',
    ...
    {
      title:
        'Optimize Angular App Performance with Azure Front Door CDN | Setup Guide | #Azure #CDN #performance',
      description: null,
      videoId: 'T1u3um483h0',
    ...
    {
      title:
        'Optimize Angular Static Files with Azure Storage | #azure  #storage',
      description: null,
      videoId: 'kBJBIMeceH4',
    ...
    {
      title:
        'Master .NET Core Web API Interview Questions | Top 10+ FAQs Q & As | #interviewtips  #dotnetcore',
      description: null,
      videoId: 'KoFRt1gN49c',
    ...
    {
      title:
        'Efficient Angular CI/CD Setup & Azure Web App Deployment | Azure DevOps Pipeline Guide #cicd #devops',
      description: null,
      videoId: 'AryMYqOt_UE',
    ...
    {
      title:
        'Leverage .NET Core 7 Background Service for Scheduled Email Notifications | Tutorial #csharp11',
      description: null,
      videoId: 'PmZtFj-K-og',
    ...
    {
      title:
        'Creating a Task Management Web App with Angular and Cosmos DB | Reactive Forms | Angular Tutorial',
      description: null,
      videoId: '78aBcZ_-5Gc',
    ...
    {
      title:
        'Python 3 Fundamentals | Age Calculator Demo using Data Types, input, output, print functions| EP4',
      description: null,
      videoId: 'E1HtD-nWRPI',
    ...
    {
      title:
        'Python 3 Fundamentals: Data Types, Primitive Data Types, Strings, Input, Output, Int, Float | EP3',
      description: null,
      videoId: 'JSAgzS0lwcY',
    ...
    {
      title:
        'Automated Email Notifications with SendGrid in .NET 7: Booking Confirmations Notification | Part 17',
      description: null,
      videoId: 'ejAxDXbc6IQ',
    ...
    {
      title:
        'Python 3 fundamentals | Python Tutorial Series | Introduction and Python Setup for development | EP1',
      description: null,
      videoId: 'Tx45dDDNmEc',
    ...
    {
      title:
        '.NET Web API Interview Questions | #csharp #interview #dotnetcore',
      description: null,
      videoId: 'VCE7dm-KCEU',
    ...
    {
      title:
        'Azure AD B2C: Enrich Tokens with External Claims using API Connectors | .Net Core 7 | Functions',
      description: null,
      videoId: 'KKkgKMMyZFw',
    ...
    {
      title:
        'Azure AD B2C User Management with Graph API & Client Credentials | Graph API',
      description: null,
      videoId: 'q00CiSh0H-o',
    ...
    {
      title:
        'Azure AD B2C Setup: User Flows, App Registration, & Integration with .NET Core 7 API and Angular 16',
      description: null,
      videoId: 'qPYk_tNc1r8',
    ...
    {
      title:
        'Mastering ASP NET Core Rate Limiting Strategies in C# NET 7 | Web Api | LSC | #csharp #dotnetcore',
      description: null,
      videoId: 'HrnuLK6O1Ps',
    ...
    {
      title:
        'Restaurant Table Booking App | Part 13: User Check-In Process and Reservation Status Update | LSC',
      description: null,
      videoId: 'iYPQYH0EOAI',
    ...
    {
      title:
        'C# 11 new features : Auto Default Struct & UTF-8 Explained | #CSharp11 #Programming',
      description: null,
      videoId: 'x0W12oXTBE0',
    ...
    {
      title:
        'C# 11 new features: Required Properties, File-Scoped, & List Patterns | #CSharp11 #Programming',
      description: null,
      videoId: 'fG2CkUwDwz4',
    ...
    {
      title:
        'Exploring Literal Strings in C# 11 Your Ultimate Guide | C# new features | #CSharp11 #Programming',
      description: null,
      videoId: 'ha7jKVcHUko',
    ...
    {
      title:
        "C# 11's Required Properties Explained | C# 11 new features | #CSharp11 #Programming",
      description: null,
      videoId: 'azPvltPOmkM',
    ...
    {
      title:
        'Auto-Default Struct Fields in C# 11 | C# new features | Learn Smart Coding | #CSharp11 #Programming',
      description: null,
      videoId: 'jTtINwWnzUs',
    ...
    {
      title:
        'C# 11 new feature: The Power of UTF-8 Suffix | C# | Learn Smart Coding | #CSharp11 #Programming',
      description: null,
      videoId: 'kNZvgVlLLM4',
    ...
    {
      title:
        'Mastering C# 11: Literal Strings with Real-time Examples | C# new features | #CSharp11 #Programming',
      description: null,
      videoId: 'sje2-76ZV3Q',
    ...
    {
      title:
        'Mastering File Scoped Types in C# 11 | C# 11 Features | Learn Smart Coding | #CSharp11 #Programming',
      description: null,
      videoId: '_MmiH6FfOLQ',
    ...
    {
      title:
        'Mastering List Pattern Matching in C# 11 | C# 11 new Features | #CSharp11 #Programming',
      description: null,
      videoId: 'UGtqI7BLrTI',
    ...
    {
      title:
        'Restaurant Table Booking App | Part 12: Angular 16  Restaurant Selection, Table Booking & User Info',
      description: null,
      videoId: 'tbACz0a23RM',
    ...
    {
      title:
        'Supercharge Your C# Productivity: Mastering Code Snippets | #csharp | #CodeSnippets | LSC',
      description: null,
      videoId: 'DGk2O9_9eS4',
    ...
    {
      title:
        'Boost Your Angular Coding with Snippets and CLI Shortcuts | #angular  | Learn Smart Coding',
      description: null,
      videoId: 'yosjgHQdPlQ',
    ...
    {
      title:
        'Exploring SAS (Shared Access Signatures): Secure Data Sharing Made Simple | SAS | Learn Smart Coding',
      description: null,
      videoId: 'DvP672XIdNM',
    ...
    {
      title:
        'Restaurant Table Reservation | Angular Application Part 1 Demo | Bootstrap Free Template | Angular',
      description: null,
      videoId: 'r5jfsXW-Ou0',
    ...
    {
      title:
        'The Power of Artificial Intelligence (AI) Explained | Learn Smart Coding',
      description: null,
      videoId: 'y3tZHNfUPVU',
    ...
    {
      title:
        'Creating Stunning Angular UIs Integrating and Customizing Bootstrap Free Templates | Restaurant App',
      description: null,
      videoId: '1Cnydfz_jtg',
    ...
    {
      title:
        'Restaurant Table Booking App | Part 11: Automating CI/CD  through Deployment Center in GitHub Action',
      description: null,
      videoId: 'qdmkFu-4GNo',
    ...
    {
      title:
        'Restaurant Table Booking App | Part 10: Provision Azure Function in Portal & deploy from VS | LSC',
      description: null,
      videoId: 'GIbdfpJ1Hp4',
    ...
    {
      title:
        'Restaurant Table Booking App   Part 9 Automating Timeslot Generation with Azure Timer Function',
      description: null,
      videoId: 'QdYX8-DE7XI',
    ...
    {
      title:
        "Web Service vs  Web API:   What's the Difference ? | Learn Smart Coding",
      description: null,
      videoId: 'd2zKweY2i5Y',
    ...
    {
      title:
        'Restaurant Table Booking App | Part 8: Configure Serilog & Application Insights in Azure | LSC',
      description: null,
      videoId: 'sKMRPqMeau8',
    ...
    {
      title:
        'Restaurant Table Booking App | Part 7: Deploying and Hosting on Azure Web App',
      description: null,
      videoId: 'PUHQWFENups',
    ...
    {
      title:
        'Restaurant Table Booking App | Part 6: Building Restaurant Controller & Retrieving Data Endpoints',
      description: null,
      videoId: 'yDVzpWwHqMY',
    ...
    {
      title:
        'Restaurant Table Booking App | Part 5: Database Migrations & Table Enhancements | DOTNET EF | LSC',
      description: null,
      videoId: 'V_-I2Mylcws',
    ...
    {
      title:
        'Restaurant Table Booking App | Part 4: Setting Up  NET Core Web API and Entity Framework Core',
      description: null,
      videoId: 'SoVjkYV-ZtE',
    ...
    {
      title:
        'Restaurant Table Booking App | Part 3:  Azure SQL Setup & DB Initialization | Azure | LSC',
      description: null,
      videoId: '8dQ9ZazO7Zc',
    ...
    {
      title:
        'Restaurant Table Booking App  |  Part 2: Database Design and Setup | Azure | LSC',
      description: null,
      videoId: 'SflcmSprRR4',
    ...
    {
      title:
        'Restaurant Table Booking App | Part 1: Architectural Overview and Tech Stack | Full Stack App | LSC',
      description: null,
      videoId: '-VPAOzOFlcM',
    ...
    {
      title:
        'Preserve Data: Upload Images & Logging in .NET Core Web API with Azure File Share & Docker Volumes',
      description: null,
      videoId: '_dA4JT1iSLs',
    ...
    {
      title:
        'Uploading Images & Logging with Docker Volume in .NET Core Web API Mounting Local Drive to Container',
      description: null,
      videoId: 'p642xZcMQuc',
    ...
    {
      title:
        'Logging & Exception Handling in Azure Web Apps Running in Containers with Serilog & AppInsight',
      description: null,
      videoId: '4uz1RiThij8',
    ...
    {
      title:
        'Deploy Multiple Docker Images to Azure Web App using Azure Container Registry | ACR | LSC',
      description: null,
      videoId: 'q6LgPWDBnf4',
    ...
    {
      title:
        'Deploy Multiple Docker Images to Azure Web App using Docker Registry and Docker Hub | LSC',
      description: null,
      videoId: 'rBc93sCcwIE',
    ...
    {
      title:
        'How to build .NET Core 7 Web API using Cosmos DB in an hour | WEB API Crash Course | .NET | LSC',
      description: null,
      videoId: 'zdih5L0I880',
    ...
    {
      title:
        'Containerized .NET 7 Web API & Web App: Docker Compose for Seamless Integration & Deployment | LSC',
      description: null,
      videoId: 'lkbw-m8ZMTM',
    ...
    {
      title:
        'Azure Cosmos DB Emulator: Local Development Setup, Database & Container, Item Management | Cosmos DB',
      description: null,
      videoId: '8NlCk2_Tl10',
    ...
    {
      title:
        'Mastering Azure Cosmos DB: Provisioning, APIs, Databases, Containers, and Item Creation Tutorial',
      description: null,
      videoId: 'kxBafyDy5LQ',
    ...
    {
      title:
        'Developing .Net 7 apps with Docker | Building Docker Images for .NET Core Apps | docker hub | Part 4',
      description: null,
      videoId: 'U91yXDS056E',
    ...
    {
      title:
        'Developing .Net 7 apps with Docker | Configuration in Docker based .Net Apps | Docker | Part 3',
      description: null,
      videoId: 'CxPYxXoPuMU',
    ...
    {
      title:
        'Developing .Net 7 apps with Docker | Logging with Docker based .Net Apps | Seri log | Part 2',
      description: null,
      videoId: 'cpYCr-Rciq8',
    ...
    {
      title:
        'Developing .Net 7 apps with Docker | Getting started with .Net Core Webapi & Docker | Part 1',
      description: null,
      videoId: 'INw6nJh9unc',
    ...
    {
      title:
        'How to Trigger an Azure Function with BlobTrigger & Input Binding to Process Excel Files | AZ-204',
      description: null,
      videoId: 'CW5M0lsQmDk',
    ...
    {
      title:
        'Getting Started with Azure Durable Functions An Example of Function Chaining | AZ-204 | LSC',
      description: null,
      videoId: 'dZsp18GZ16w',
    ...
    {
      title:
        'How to create Custom Message Service Using Toastr | ngx-toastr | Angular | Auto Complete | LSC',
      description: null,
      videoId: '7sQdfhjMESQ',
    ...
    {
      title:
        'Angular Custom Directives A Beginner’s Guide with Real Time Scenario | Directives | Angular | LSC',
      description: null,
      videoId: 'pwX5tYt15tU',
    ...
    {
      title:
        'How to Build Custom Preload Strategies in Angular  | Performance | Security | LSC',
      description: null,
      videoId: 'e5SiArFpDTw',
    ...
    {
      title:
        'How to implement Angular PreloadingStrategy: Boosting App Performance with PreloadAllModules | LSC',
      description: null,
      videoId: 'jTaD4226hPc',
    ...
    {
      title:
        'Understanding the CanLoad Guard in Angular: Real-time Example | Guard | Angular | LSC',
      description: null,
      videoId: 'y4GmHjYW8y4',
    ...
    {
      title:
        'Building a Planner App with Angular 14, Azure AD B2C Authentication, and .NET Core Web API | LSC',
      description: null,
      videoId: '9R1JGMI7dvw',
    ...
    {
      title:
        'Exploring the Power of ChatGPT API in .NET Core 6 Web API Development | ChatGTP | OpenAI.API | LSC',
      description: null,
      videoId: 'tEdwLpXVB_0',
    ...
    {
      title:
        'Planner App demo powered by DOTNET Core 6 using CQRS and Angular 15 | Demo App | .NET Core | Angular',
      description: null,
      videoId: 'kUyS4MYe5yE',
    ...
    {
      title:
        'Azure Redis Cache: How to Improve Web API Performance in Easy Steps | Redis | AZ-204 | Azure | LSC',
      description: null,
      videoId: 'TFn9F2Fg0zg',
    ...
    {
      title:
        'Creating a .NET Core Web API and Database Design from Scratch using ChatGPT | OpenAI | LSC',
      description: null,
      videoId: 'MpqOP-TajaU',
    ...
    {
      title:
        'Building a Chatbot in Angular with ChatGPT: Step-by-Step Tutorial | ChatGPT | Angular | LSC',
      description: null,
      videoId: 'JlK8l_lvBko',
    ...
    {
      title:
        'Build ChatGPT powered AI app in Angular  | ChatGPT Crash Course | ChapGPT | Angular | LSC',
      description: null,
      videoId: '-Ode2RQb4yU',
    ...
    {
      title:
        'Implement caching policy in the Azure API Management Part 7 | Demo | Azure | AZ-204 | LSC',
      description: null,
      videoId: 'EfgZmA-AKlw',
    ...
    {
      title:
        'Implementing throttling in Azure API Management Part 6 | Demo | Azure | AZ-204 | LSC',
      description: null,
      videoId: 'OgLQk1Yew0M',
    ...
    {
      title:
        'Protect API from unauthorized with API key and client certificates in API Management | Part 5 | Demo',
      description: null,
      videoId: 'JtjbnmgusOU',
    ...
    {
      title:
        'Concepts of Azure API Management Securities and Policies Part 4 | AZ-204 | Azure | LSC',
      description: null,
      videoId: 'wCthAi353bE',
    ...
    {
      title:
        'Master Azure API Management: Full Course on Managing and Securing APIs in the Cloud | AZ-204 |  LSC',
      description: null,
      videoId: 'Kn7NRH9h_ug',
    ...
    {
      title:
        'How to set up access for developers in Azure API Management Part 3 | Demo | AZ-204 | Azure | LSC',
      description: null,
      videoId: 'DNFOFJsv1yQ',
    ...
    {
      title:
        'How to set up Azure API Management Service in Azure portal Part 2 | Azure | | Demo | LSC',
      description: null,
      videoId: 'iZTETR99FrM',
    ...
    {
      title:
        'Azure API Management Part 1 | Explore API Gateway Structure | AZ-204 | Azure | LSC',
      description: null,
      videoId: 'H-tUZLdfRP4',
    ...
    {
      title:
        "Exploring Microsoft Graphs Made Easy: A Beginner's Guide to Using Graph Explorer | AZ-204 | LSC",
      description: null,
      videoId: 'u5a2UUmJKu0',
    ...
    {
      title:
        'How to access keys & certificates from azure key vault using DOTNET SDK | AZ-204 | Azure | LSC',
      description: null,
      videoId: 'fKfd1n1HBMM',
    ...
    {
      title:
        'How to enable soft delete and purge protection in AZURE Key Vault | AZ-204 | Key Vault | Azure | LSC',
      description: null,
      videoId: 'Gl-JMywVetc',
    ...
    {
      title:
        'How to setup pre-deployment approval in Azure DevOps Release Pipeline | DevOps | CICD pipeline | LSC',
      description: null,
      videoId: 'EtngiASuTrY',
    ...
    {
      title:
        'Retrieving Secrets from Azure Key Vault in .NET Core: A Step-by-Step Guide | Azure | AZ-204 | LSC',
      description: null,
      videoId: 'hEw_Vi21jWM',
    ...
    {
      title:
        'Configure authentication in Angular and WEB API by using Azure Active Directory B2C | LSC',
      description: null,
      videoId: 'vEwLQYgQvGI',
    ...
    {
      title:
        'Configure authentication in Angular and WEB API by using Azure Active Directory B2C | Part 6 | LSC',
      description: null,
      videoId: '_RIDuMFHvIs',
    ...
    {
      title:
        'Dynamic CSS in Angular: Using Class Bindings and ngClass Directive | LSC',
      description: null,
      videoId: 'uJmOV8Y0GuA',
    ...
    {
      title:
        'Dynamic Styles in Angular: Using Style Bindings and ngStyle Directive | LSC',
      description: null,
      videoId: '1KBfdmfPbw0',
    ...
    {
      title:
        'Mastering ngSwitch Directive in Angular: A Complete Tutorial | Angular | LSC',
      description: null,
      videoId: 'Y1IhacxDVx8',
    ...
    {
      title:
        'Set up sign-up and sign-in with a Google account using Azure Active Directory B2C | Angular | LSC',
      description: null,
      videoId: '9_p7Xr1pxls',
    ...
    {
      title:
        'Configure authentication in Angular and WEB API by using Azure Active Directory B2C | Part 5 | LSC',
      description: null,
      videoId: 'oUXXRhpIw2w',
    ...
    {
      title:
        'Configure authentication in Angular and WEB API by using Azure Active Directory B2C | Part 4 | LSC',
      description: null,
      videoId: 'fdYqaEAXiEM',
    ...
    {
      title:
        'Configure authentication in Angular and WEB API by using Azure Active Directory B2C | Part 3 | LSC',
      description: null,
      videoId: 'saQQcR1PATk',
    ...
    {
      title:
        'Configure authentication in Angular and WEB API by using Azure Active Directory B2C | Part 2 | LSC',
      description: null,
      videoId: 'o5gKCAir2vU',
    ...
    {
      title:
        'Configure authentication in Angular and WEB API by using Azure Active Directory B2C | Part 1 | LSC',
      description: null,
      videoId: 'Y44VMVwRUWs',
    ...
    {
      title:
        'Angular 13 Reactive forms with real-time WEB API | CRUD Operation | Angular 13 | Learn Smart Coding',
      description: null,
      videoId: '5vnWjjKpPW8',
    ...
    {
      title:
        'Angular 13 Full Course for Beginners | Shopping App | Angular | Learn Smart Coding',
      description: null,
      videoId: 'gbtlCsznXBU',
    ...
    {
      title:
        'How to configure the connection strings in Azure WEB APP for DOTNET CORE WEB API | Azure | LSC',
      description: null,
      videoId: 'gYbb_TYLSes',
    ...
    {
      title:
        'How to configure Application Insights in Azure and DOTNET CORE WEB API | Azure | Learn Smart Coding',
      description: null,
      videoId: 'NWcrAANisvk',
    ...
    {
      title:
        'ASP.NET CORE WEB API Complete course | EF CORE | CRUD | Shopping App | Tutorial for Beginners | LSC',
      description: null,
      videoId: 'LgD_II5-9eI',
    ...
    {
      title:
        'How to pass parameters to function arguments using (...) spread operator | JavaScript | ES6 | LSC',
      description: null,
      videoId: '0uvjBo9mevo',
    ...
    {
      title:
        'How to shallow an object literal using (...) spread operator | JavaScript | ES6 | Learn Smart Coding',
      description: null,
      videoId: '5Y4WUj27LV0',
    ...
    {
      title:
        'How to copy an array of primitive type using (...) spread operator | JavaScript | ES6 | LSC',
      description: null,
      videoId: 'S1MTKGkweYA',
    ...
    {
      title:
        'Angular 13 Tutorial : Shopping App Demo | Angular | Learn Smart Coding',
      description: null,
      videoId: 'rgnXDDvoGV0',
    ...
    {
      title:
        'How to deploy Angular app to Azure app service using CI/CD pipeline from GIT repo | Angular | LSC',
      description: null,
      videoId: '24w65VnlrOU',
    ...
    {
      title:
        'GIT Tutorial for Beginners:  GIT basic commands with real-time examples | Learn Smart Coding',
      description: null,
      videoId: 'Xohwrcr7AKQ',
    ...
    {
      title:
        'How to prevent users from navigating away from a component using canDeactivate guard | Angular | LSC',
      description: null,
      videoId: 'WDpK5k8Bc2A',
    ...
    {
      title:
        'How to upload files using Angular to DOTNET Core Web API using Reactive Forms | Learn Smart coding',
      description: null,
      videoId: '6A-aYX355cg',
    ...
    {
      title:
        'How to handle exceptions in Angular HTTP Service | Angular for Beginners | Learn Smart Coding',
      description: null,
      videoId: 'e-NNM02Y9To',
    ...
    {
      title:
        'AZ-204 | How to set access tiers for Azure Storage Accounts and Block Blobs | Learn Smart Coding',
      description: null,
      videoId: 'lwBPeeBwRd4',
    ...
    {
      title:
        'How to pass parameters to a route and navigate to a route using code | Angular | Learn Smart Coding',
      description: null,
      videoId: 'An5_HX4aics',
    ...
    {
      title:
        'AZ-204 | Setting and Retrieving Properties and Metadata | Blob Storage | Learn Smart Coding',
      description: null,
      videoId: 'CrMZ_LubWL0',
    ...
    {
      title:
        'AZ-204 | Interacting with Data Using the Azure SDK for .NET | Blob Storage | Learn Smart Coding',
      description: null,
      videoId: 'MEmHi6NzFhE',
    ...
    {
      title:
        'AZ-204 | Develop Solutions with Blob Storage | Storage Accounts | Azure | Learn Smart Coding',
      description: null,
      videoId: '-xYEOIBFroI',
    ...
    {
      title:
        'How to define and read query parameters in Angular | Angular | Learn Smart Coding',
      description: null,
      videoId: 'jyGONf58Oks',
    ...
    {
      title:
        'How to build Custom Pipes and use In-built pipes in Angular | Angular | Learn Smart Coding',
      description: null,
      videoId: 'mIn08XD1_78',
    ...
    {
      title:
        'How to implement Route Resolver in Angular | Angular | Interview Topic | Learn Smart Coding',
      description: null,
      videoId: 'ZTZJpbCPWrg',
    ...
    {
      title:
        'How to apply animation in Angular | Animating Route Transitions | Animations | Learn Smart Coding',
      description: null,
      videoId: 'G9zAdwy3Skk',
    ...
    {
      title:
        'How to log HTTP Request & Response in Azure App Insights using DOTNET CORE | Learn Smart Coding',
      description: null,
      videoId: '0aJwxbDp0-Q',
    ...
    {
      title:
        'AZ-204 | Azure App Service Web Apps | Deploy code to web app using GITHUB | Learn Smart Coding',
      description: null,
      videoId: 'TwcX28gFSU8',
    ...
    {
      title:
        'AZ-204 | Azure App Service Web Apps | Configure custom domain and SSL binding | Learn Smart Coding',
      description: null,
      videoId: 'r0jXgGKinC0',
    ...
    {
      title:
        'AZ-204 | Azure App Service Web Apps | Configuring database connection string | Learn Smart Coding',
      description: null,
      videoId: 'vQZAUhTHPOE',
    ...
    {
      title:
        'AZ-204 | Azure App Service Web Apps | Implementing Auto Scaling in App Service | Learn Smart Coding',
      description: null,
      videoId: 'Gw7yZbcmoE0',
    ...
    {
      title:
        'AZ-204 | Azure App Service Web Apps | Scaling App Service on a schedule | Learn Smart Coding',
      description: null,
      videoId: 'SWwsehQs4MI',
    ...
    {
      title:
        'AZ-204 | Azure App Service Web Apps | Manually Scale App Service | Learn Smart Coding',
      description: null,
      videoId: 'Qf4nanIEFE0',
    ...
    {
      title:
        'AZ-204 | Azure App Service Web Apps | Securing a web app with SSL Certificate | Learn Smart Coding',
      description: null,
      videoId: 'bhBn2-DI7w0',
    ...
    {
      title:
        'AZ-204 | Azure App Service Web Apps | Create Web App using Azure AR Template | Learn Smart Coding',
      description: null,
      videoId: '32b5SC00u2A',
    ...
    {
      title:
        'AZ-204 | Azure App Service Web Apps | Create Web App with Powershell | Learn Smart Coding',
      description: null,
      videoId: 'jxs3lNoQT8A',
    ...
    {
      title:
        'AZ-204 | Azure App Service Web Apps | Create Web App with Azure CLI | Learn Smart Coding',
      description: null,
      videoId: 'K10e67FT4OA',
    ...
    {
      title:
        'AZ-204 | Azure App Service Web Apps | Create Web App in Azure Portal | Learn Smart Coding',
      description: null,
      videoId: '0czq54ucAPs',
    ...
    {
      title:
        'AZ-204 | Azure App Service Web Apps | Understanding of App Service Plan & ASE | Learn Smart Coding',
      description: null,
      videoId: 'fro8GD9AjP8',
    ...
    {
      title:
        'Mastering Default Parameters in JavaScript (ES6) | JavaScript Tutorial #es6 #javascript',
      description: null,
      videoId: 'o38boqzQ5HI',
    ...
    {
      title:
        'How to use Rest Parameters in JavaScript | ES6 | JavaScript | Learn Smart Coding',
      description: null,
      videoId: '_6UtGVnNX0U',
    ...
    {
      title:
        'Angular Getting Started | How to apply Routing  in application | Part 10 | Learn Smart Coding',
      description: null,
      videoId: 'kZY0sMJTpEo',
    ...
    {
      title:
        'Angular Getting Started | Data Bindings Examples | Part 5 | Learn Smart Coding',
      description: null,
      videoId: 'JBAmDYVbCVU',
    ...
    {
      title:
        'Angular Getting Started | Data Bindings usage in Components | Part 6 | Learn Smart Coding',
      description: null,
      videoId: 'A75MCRN02Mw',
    ...
    {
      title:
        'Angular Getting Started | Data Bindings | In-Built Directives Examples | Part 5 | Learn Smart Coding',
      description: null,
      videoId: 'FsrCIvAF1Nc',
    ...
    {
      title:
        'Entity Framework Core commands explained with examples | DOTNET CORE | Learn Smart Coding',
      description: null,
      videoId: '3okWEZfGF6w',
    ...
    {
      title:
        'Angular Getting Started | Software Installation and App Setup | Part 2 | Learn Smart Coding',
      description: null,
      videoId: 'Fu2KvkVKgS0',
    ...
    {
      title:
        'Angular Getting Started | Demo Application Introduction | Part 1 | Learn Smart Coding',
      description: null,
      videoId: 'PsvMtvqmAWg',
    ...
    {
      title:
        'Configure Azure SQL Server and Database and access from local development machine | Add Client IP',
      description: null,
      videoId: 'Mx4eD1M-sOw',
    ...
    {
      title:
        'AZ-204 | Provision virtual machines using PowerShell | Implement IaaS solutions | Part 3',
      description: null,
      videoId: '3ncV8e2AFSk',
    ...
    {
      title:
        'AZ-204 | Provision virtual machines using Azure CLI | Implement IaaS solutions | Part 2',
      description: null,
      videoId: '11seR1WS19U',
    ...
    {
      title:
        'AZ-204 | Provision virtual machines using the Azure portal | Implement IaaS solutions | Part 1',
      description: null,
      videoId: '-_5Wt9O_aqk',
    ...
    {
      title:
        'How to solve Http Error 500.19 Internal Server Error for DOTNET Core application',
      description: null,
      videoId: 'ZCjvZn4iU-U',
    ...
    {
      title:
        'How to upload a file using DOTNET CORE | Karthik | Everyone can code ! | Learn Smart Coding',
      description: null,
      videoId: 'tqjGuKEhK38',
